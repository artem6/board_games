...
export const getNewHand = () => {
  const cards: string[] = [];
  for (let i = 0; i < 5; i++) cards.push(getRedCard());
  return cards;
};
...
const redCards = [
  ...
  `Adolf Hitler - 1889-1945, turned Germany into a militarized dictatorship, caused the slaughter of millions and launched World War II. `,
  ...
  `Pears - More than 40 million metric tons are produced worldwide every year. How 'bout them pears? `,
  // `Pears - Johnny Pearseed traveled across the United States planting seeds for apple trees. `,
  `Pears & Oranges - Don't even TRY to compare them. `,
  ...
  `Beanie Babies - Tiny plush collectible to love and cherish. Don't take that tag off! `,
  ...
  `Card Games - "Pears to Pears" might be fun! `,
  ...
  `Carrot & Sticks - The ultimate motivator... for a donkey. `,
  ...
  `Ketchup - Ketchup is made from tomatoes, onions, sugar, and spices. `,
  `Ketchup & Mustard - The salsa revolution brought down their condiment empire. `,
  ...
  // `Circus Peanuts - Chewy, orange marshmallow things shaped like peanuts. Seldom found at the circus. `,
  ...
  // `Dennis Rodman - 1961- , American professional basketball player and full-time human oddity. `,
  ...
  // `Disneyland - You've just won the "Pears to Pears(R) Grand Masters Tournament." Where're you gonna go? `,
  ...
  // `Judge Judy - Ms. Sheindlin presides over real-life cases on this TV courtroom show. "I'm the boss, pearsauce!" `,
  ...
  `Legos - Get more blocks! We're building the Golden Gate Bridge. `,
  ...
  `Pinatas - Papier-mach‚ animals filled with candy and whacked with a stick. `,
  ...
  // `Pinepears - Shaped like a football, tastes like a fruit. `,
  ...
  `Splinters - The worst ones are under your fingernails. `,
  ...
  `Suit and Tie - It's business as usual! `,
  `Summer - SCHOOL'S OUT! `,
  ...
  // `The YMCA - The Young Men's Christian Association has 30 million members in 110 countries. "It's fun to stay at the Y-M-C-A." -The Village Peopl `,
  ...
  `War and Peace - Tolstoy's 1805 epic novel of the Napoleonic wars, a celebration of Russian spirit. `,
  ...
  `Water Balloons - I'll fill them and you tie them. `,
  ...
  `Donald Trump - 45th President of the United States. Enjoys firing people. `,
  `Barack Obama - 44th President of the United States. Yes we can. `,
  `Settlers of Catan - A popular German resource collecting and building game. `,
  `Pears to Pears - This game. The one you're playing right now.  `,
  `Sushi - Literally means vinegar rice, often made with raw fish. `,
  `Google - I'm feeling lucky. `,
  `Facebook - We're watching you. `,
  `Uber - Vote yes on Prop 22. `,
  `Instacart - We will deliver your toilet paper. `,
  `Covid-19 - Yep, still going... `,
  `Tik Tok - Tweens only. `,
  `The New York Times - Have you ever read one back to back? `,
  `Lyft - We're cooler than Uber. `,
  `Netflix - Three, two, one, autoplay. `,
  `YouTube - Watch your favorite 20-year-olds earn millions. `,
  `Zoom - Videoconference company. That's the sound our stock makes when it's going up. `,
  `Wikipedia - A crowdsourced encyclopedia that's surprisingly accurate. `,
  `University of Pennsylvania - Don't you dare confuse us with Penn State. `,
  `Slack - Let's make work unproductive. `,
  `LinkedIn - Such ..*yawn* interesting.. updates. `,
  `Google Maps - The only map you can trust. `,
  `Spotify - How do they make money again? `,
  `Gmail - Must.. not.. check.. ooh one new email! `,
  `Chrome - Incognito mode is definitely used to plan surprise parties. `,
  `Firefox - But we're so indie... `,
  `WeChat - We have more active users than anyone can imagine. `,
  `Pinterest - Literally only used for 2-3 purposes. `,
  `Yelp - Food was fantastic, but service was so slow and didn't refill my water. 1 star. `,
  `Android OS - It is a known fact that Android users don't spend any money. `,
  `iPhone - We release the same thing every year but everyone keeps buying anyways :D `,
  `Data Scientists - We know Python better than we know English. `,
  `Software Engineers - We built the thing you're using right now. `,
  `Product Managers - An inexplicable role in tech that tells the entire team what to build but has no formal authority. `,
  `Product Designers - Must make everything look CONSISTENT. `,
  `Amazon - Buy everything now. `,
  `Emojis - 🍆 `,
  `Google Translate - I can understand ALL the languages. `,
  `Twitter - 140 characters is too long... `,
  `Reddit - r/AMA `,
  `Zillow - I just need to know how much my neighbor's house is worth. `,
  `Costco - Everyone's favorite membership-only warehouse club. `,
  `Steinway Grand Piano - Starting at only $100,000. `,
  `Playstation - Pure-sute-shion. `,
  `Walmart - We're family run... sort of. `,
  `Xbox - We're so hip and not corporate. `,
  `Animal Crossing - Don't worry about the debt situation. Let me help you expand your living space.. - Tom Nook. `,
  `Legend of Zelda - Apparently some of the best games ever made. `,
  `Super Mario series - So many... can't keep track.. `,
  `Mario Kart - Learn driving skills very transferable to the real world. `,
  `Grand Theft Auto - Stab, shoot, and drive your way out of everything. `,
  `Moomins - A family of mystical and fantastical hippo-like creatures living in Scandinavia. `,
  `Pluto - No longer classified as a planet as of 2006. `,
  `Cthulhu - A fictional cosmic entity created by horror writer H. P. Lovecraft. Has many tentacles and smells bad. `,
  `Minecraft - A sandbox video game where you can literally build anything you can think of out of giant blocks. `,
  `PayPal - Used to pay for your eBay purchases. `,
  `eBay - The place you go when you can't find what you want on Amazon. `,
  `Tesla - The electric car company run by eccentric billionaire Elon Musk. `,
  `Japanese - Nihongo o hanashimasu ka. `,
  `Godzilla - Also known as GO-JI-RA. `,
  `Frederic Chopin - Cough cough. `,
  `Ludwig van Beethoven - Dot dot dot dash. `,
  `Wolfgang Amadeus Mozart - Composed minuets at age 5, symphonies at age 8. `,
  `Franz Liszt - The source of Lisztomania. Women would faint at his piano concerts. `,
  `Johann Sebastian Bach - Not to be confused with Carl Philipp Emanuel Bach. `,
  `Tetris - Everyone's dying for an I-block. `,
  `The Sims - Play a more boring version of your life. `,
  `Skyrim - 10 years after release, still selling for $60. `,
  `Final Fantasy - Can someone please explain what is going on in the story? `,
  `Samsung - Korean conglomerate that makes everything from washing machines to phones. `,
  `Social Media - You can forget about your real social life. `,
  `Lion King - Hakuna Matata. `,
  `The Little Mermaid - Under the sea, fish eat each other. `,
  `Toy Story - I am never throwing away an old toy ever again. `,
  `Toyota - Boring, safe, and dependable. `,
  `Michelin-Starred Restaurants - Costs a lot but tastes amazing. `,
  `Social Distancing - No offense but I don't trust your germs. `,
  `Muggles - The non-magical people in the Harry Potter world. They got gypped. `,
  `Winston Churchill - The leader of the United Kingdom during World War II. A rotund orotund orator. `,
  `Anime - Not cartoons. Totally different from cartoons. `,
  `Manga - What really delineates whether something is a comic book or a manga? `,
  `Elon Musk - Founder and CEO of way too many companies. `,
  `Mark Zuckerberg - 36 years old and worth $100 billion. So that means $2.8 billion per year? `,
  `Jeff Bezos - Admit it, you have given him so much money already. `,
  `Sloths - Instead of eating more, they just move less. `,
  `Louis Vuitton - Extremely expensive (possibly overpriced) handbags. `,
  `Rolex Watches - They do exactly the same thing as your $10 watch. `,
  `Greek Yogurt - Extremely thick yogurt. Very high in protein. `,
  `Fermented Shark - Also known as Hakarl, national dish of Iceland consisting of shark that's been fermented and left to dry for 4-5 months. `,
  `Haggis - Savory pudding made out of sheep guts and random parts. `,
  `Ramen - Can either be instant or not. `,
  `Hot Pot - Great for a cold blustery day. `,
  `Pad Thai - Literally means Thai stir fry. Popularized by the Thai government to galvanize nationalism. `,
  `Fried Chicken - Amazingly delicious for how simple it is. `,
  `Taiyaki - A fish-shaped sweet desert from Japan often filled with red bean paste. `,
  `General Tso's Chicken - Apparently General Tso was a real person. `,
  `Caviar - Very expensive fish eggs. Officially only refers to the roe of sturgeons. `,
  `Red Lobster - American casual chain of restaurants specializing in (so-so) seafood. `,
  `Planet Earth - A critically acclaimed BBC nature documentary series narrated by David Attenborough. Rated 9.4 on IMDB! `,
];
...
const greenCards = [
  ...
  // 'Dark - (without light, nearly black)',
  ...
  'Fine - (worthy, delicate, all right)',
  ...
  'Heavy - (not light, bulky)',
  'Helpful - (useful, assisting)',
  ...
  'Square - (rectangular, uncool, dull)',
